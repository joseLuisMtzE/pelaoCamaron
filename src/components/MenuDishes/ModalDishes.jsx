...
function ModalDishes({
  ...
  const { deleteDishes } = useContext(DishesContext);
        ...
        <div style={{ zIndex: '60', display: 'block' }}>
          ...
          >
            ...
            <Row>
              <Col span={8}>
                <img
                  src="https://cdn2.iconfinder.com/data/icons/pittogrammi/142/97-512.png"
                  alt=""
                  style={{ width: '15px' }}
                />
                {categoria.nombre}
            ...
            <Row>
              <Col span={12}>
                <img
                  src="https://cdn1.iconfinder.com/data/icons/electronics-outline-24/24/kitchen_scale_food_scale_weighing_scale_weight_machine_weight_scale-512.png"
                  alt=""
                  style={{ width: '15px', margin: '5px' }}
                />
                {peso} gr
              ...
              <Col span={12}>
                <img
                  src="https://cdn0.iconfinder.com/data/icons/pinpoint-interface/48/taxes-and-fees-512.png"
                  alt=""
                  style={{ width: '15px', margin: '5px' }}
                />
                ${precioConIva}
